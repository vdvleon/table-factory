  ...
  (0, _createClass3.default)(TableFactory, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          _props$pagination$per = _props$pagination.perPage,
          perPage = _props$pagination$per === undefined ? 0 : _props$pagination$per,
          rest = (0, _objectWithoutProperties3.default)(_props, ['columns', 'data', 'elemProps', 'header', 'children', 'pagination']);
      ...
      var slicedData = perPage > 0 ? normalizedData.slice(perPage * (page - 1), perPage * page) : normalizedData;
      ...
      var thead = header && this.renderHeader(columns_, slicedData, elemProps_);
      var tbody = this.renderBody(columns_, slicedData, header, elemProps_);
      return _react2.default.createElement(
        'table',
        (0, _extends3.default)({}, evalElemProps(tableProps, slicedData, columns_), props),
        thead,
        tbody
      );
    }
    ...
    value: function parseChildren(children, columns, elemProps, parent) {
      ...
      return _react2.default.Children.map(children, function (el) {
        ...
        if (simpleProps.indexOf(type) !== -1) {
          elemProps[type] = _this3.propsWithDefault((0, _lodash.omit)(props, ['children']), elemProps[type]);
        } else if (type === 'th') {
          var name = props.name,
          ...
          if ((0, _lodash.isString)(name)) {
            ...
            elemProps[type] = _this3.propsWithDefault(props_, elemProps[type]);
          }
        } else if (type === 'tr') {
          (function () {
    ...
    key: 'propsWithDefault',
    value: function propsWithDefault(props, originalProps) {
      var _this4 = this;
